...
import { ClerkLoaded, SignedIn, UserButton, SignedOut, useClerk } from "@clerk/clerk-react"
...
const UserAvatar = () => {
    ...
    return <div className='relative min-w-[2.25rem] h-9'>
        ...
        <ClerkLoaded>
            <SignedIn>
                <UserButton afterSignOutUrl='http://localhost:3333' appearance={{ elements }} /> {/*TODO change url*/}
            </SignedIn>
            <SignedOut>
