...
import type { ToastProps, ToastActionElement } from '@wheretoplay/components';
...
function useToast() {
  ...
  return {
    ...state,
    toast: (text: string) => toast({ description: text, variant: 'default', duration: TOAST_REMOVE_DELAY }),
